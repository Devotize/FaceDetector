...
class ClothesDefinerImpl @Inject constructor(
    ...
    private fun processBitmap(source: Bitmap): Bitmap {
        ...
        val frameToCropTransformations =
            getTransformationMatrix(width, height, size, size, 0, false)
    ...
    companion object {
        const val TAG = "ClothesDefinerImpl"
